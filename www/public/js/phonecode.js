    ...
    (function($) {
        $.widget('custom.phonecode', {
            ...
            _create: function() {
                ...
                var selector = $('<div class="country-phone-selector"><div class="country-phone-selected"></div><div class="country-phone-options" id="country-phone-options"></div></div>');
                $(selector).prependTo(container);

                var prefixName = this.options.prefix ?
                    this.options.prefix : '__phone_prefix';

                var hidden = $('<input type="hidden" id="phone_prefix" name="'+ prefixName +'" value="'+ this.options.default_prefix +'">');
