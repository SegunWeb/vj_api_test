 ...
 * HeaderMenu
 *
 * @ORM\Entity(repositoryClass="App\Repository\HeaderMenuRepository")
 ...
 */
class HeaderMenu implements TranslatableInterface
{
	 ...
	 * @var HeaderMenu
	 * @Gedmo\TreeParent
	 * @ORM\ManyToOne(targetEntity="HeaderMenu", inversedBy="children" )
	 ...
	 * @var HeaderMenu[]
	 *
	 * @ORM\OneToMany(targetEntity="HeaderMenu", mappedBy="parent")
	 * @ORM\OrderBy({"lft" = "ASC"})
	 */
	private $children;
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Page", inversedBy="headerMenu")
	 * @ORM\JoinColumn(name="static_page_id", referencedColumnName="id", nullable=true, onDelete="CASCADE")
	 */
	private $staticPageId;
	
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\VideoCategories", inversedBy="headerMenu")
	...
	public function addChild( HeaderMenu $child ): self
	{
	...
	public function removeChild( HeaderMenu $child ): self
	{
		if ( $this->children->contains( $child ) ) {
